...
public class CreateDeleteProjectDemo {
	...
	private static void createCustomer()
	{
		try
		{
			...
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("tabassum1");
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_descriptionField")).sendKeys("vijayanagar1");
			Thread.sleep(2000);
